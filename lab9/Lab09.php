    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              foreach ($countries as $value) {
                  echo '<a href="list.php?country=Canada" role="button" class="btn btn-default">'.$value.'</a>';
              }
		...
		<ul class="caption-style-2">
          ...
          foreach ($images as $value){
              print_r("<li>");
              print_r('<a href="detail.php?id='.$value["id"].'"class="img-responsive">');
              print_r('<img src="images/square/'.$value['path'].'" alt="'.$value["title"].'">');
              echo '<div class="caption">';
              echo '<div class="blur"></div><div class="caption-text">';
              print_r('<h1>'.$value["title"].'</h1>');
              echo '</div></div></a></li>';
